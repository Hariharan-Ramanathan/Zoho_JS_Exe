...
for(let i=0;i<img.length;i++){
    ...
    thumbnail.addEventListener('click', (e)=>{
        ...
        Ceo.innerHTML=img[i].ceo;
        Year.innerHTML=img[i].Year;
        mouseCords.innerHTML = e.clientX +' , '+ e.clientY;
